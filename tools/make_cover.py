...
用法（py -3.12）：
  封面:  py -3.12 make_cover.py cover --title "让 AI 遵守规则" --subtitle "别靠提醒，靠制度" --type methodology --out "分发/2026-08-15-xxx/封面"
  小红书: py -3.12 make_cover.py xhs --cards cards.json --out "分发/2026-08-15-xxx/小红书"
